 ...
 * 2.发送编码数据到转发服务器
 */
public class PushCameraPreviewActivity extends AppCompatActivity {
    ...
    private static final long DURATION_SEC = 1200;             // 8 seconds of video
...
//        getWindow().addFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN);
    ...
    NetworkNative mNetworkNative = new NetworkNative();
...
//                drain(false);
                ...
                Log.d("test", "sending frame to encoder");
