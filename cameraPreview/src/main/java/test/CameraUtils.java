...
public class CameraUtils {
    ...
    public static void choosePreviewSize(Camera.Parameters parms, int width, int height) {
        ...
        List<Camera.Size> supportedPictureSizes = parms.getSupportedPictureSizes();
        Log.d(TAG, "supportedPictureSizes.size():" + supportedPictureSizes.size());
        for (Camera.Size supportedPictureSize : supportedPictureSizes) {
            Log.d(TAG, "supportedPictureSize:" + supportedPictureSize.width+ "x" +supportedPictureSize.height);
        }
